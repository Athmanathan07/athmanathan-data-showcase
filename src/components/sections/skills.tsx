      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {skillCategories.map((category, index) => (
            <div
              key={category.name}
              className={`card relative hover:shadow-portfolio-accent/40 transition-opacity bg-white dark:bg-portfolio-gray-900 duration-700 ${isVisible ? 'opacity-100' : 'opacity-0'} transition-transform hover:scale-105`}
