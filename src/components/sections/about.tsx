      ...
      <div className="container mx-auto px-4">
        ...
        <div className={`flex flex-col md:flex-row gap-10 items-center ${isVisible ? 'animate-fade-in' : 'opacity-0'}`}>
          <div className="w-full md:w-1/3 flex justify-center">
            <div className="relative bounce-on-hover group">
              ...
              />
              {/* Bounce Mail icon at corner */}
              <div className="absolute -bottom-2 -right-2 bg-portfolio-accent text-white p-2 rounded-full shadow-lg animate-bounce-once">
          ...
          <div className="w-full md:w-2/3">
            <div className="prose prose-lg dark:prose-invert max-w-none">
              ...
              <div className="mt-8 flex flex-wrap gap-4">
                <a
                  href="#contact"
                  className="btn-primary inline-flex items-center gap-2 animate-bounce-once shadow-md hover:scale-105 transition-transform"
                >
